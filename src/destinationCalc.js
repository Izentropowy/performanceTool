...
export function calcLandingDistance(
  ...
  let lowerLd1 = departure.interpolate(
    pressFloor,
    pressCeil,
  ...
  let higherLd1 = departure.interpolate(
    pressFloor,
    pressCeil,
  ...
  let lowerLd2 = departure.interpolate(
    pressFloor,
    pressCeil,
  ...
  let higherLd2 = departure.interpolate(
    pressFloor,
    pressCeil,
